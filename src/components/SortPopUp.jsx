...
import {  setSortPopUpMode, setSortPopUpIndex, setAscDesc } from "../redux/slices/pageParamsSlice"
    ...
    <div ref={sortRef} className="sort">
      <div className="sort__label">
        <svg
          ...
          onKeyPress={() => dispatch(setAscDesc(ascDesc === "asc" ? "desc" : "asc"))}
          role="button"
          tabIndex={0}
        >
          <path
        ...
        <span
          ...
          onKeyPress={() => dispatch(setSortPopUpMode(!sortPopUpMode))}
          role="button"
          tabIndex={0}
