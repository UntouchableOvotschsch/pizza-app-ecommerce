...
import {AscDesc} from "../redux/slices/slicesTypes";
...
const SortPopUp: React.FC<SortPopUpProps> = React.memo((props) => {
        ...
        <div ref={sortRef} className="sort">
            <div className="sort__label">
                <svg
                    ...
                    onClick={() => dispatch(setAscDesc(ascDesc === AscDesc.ASC ? AscDesc.DESC : AscDesc.ASC))}
                >
                    <path
